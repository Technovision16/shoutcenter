...
.centered-form .panel{
  ...
  .bc {
background-color:rgba(4,139,34,0.1);}
  
  .dc {
background-color:rgba(120,9,34,0.1);
color:white;}
...
<div class="container">
        ...
        <div class="col-xs-14 col-sm-6 col-md-6 col-sm-offset-2 col-md-offset-6">
        	<div class="panel panel-success animated flip ">
...
<div class="container">
<!--<img border="0" id="basetop0" src="" height="100%" width="130%"></img>-->


    <div class="row">
	<div class="col-md-6 col-md-offset-7 pull-left">
 <img border="0" id="basetop0" class="animated slideInLeft"src="images/icon0057.png" height="50%" width="50%"></img>
</div>
        <div class="col-sm-5 col-md-7 col-md-offset-4 pull-left">
		
            <div class="panel panel-warning bc animated rubberBand "style="border:none;">
			
                <div class="panel-heading bc opacit " > <strong class="">ShoutCenter</strong>

                </div>
                <div class="panel-body dc">
                    <form class="form-horizontal" role="form" enctype="multipart/form-data" action="login_exec.php" method="post">
                        <div class="form-group">
                            <label for="inputEmail3" class="col-sm-3 control-label"><i class="fa fa-user fa-2x"></i></label>
                            <div class="col-sm-7">
                                <input type="username" class="form-control opaci" name="username"id="inputEmail3" placeholder="Username" required="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputPassword3" class="col-sm-3 control-label"><i class="fa fa-key fa-2x"></i></label>
                            <div class="col-sm-7">
                                <input type="password"name="password" class="form-control opaci" id="inputPassword3" placeholder="Password" required="">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group last">
                            <div class="col-sm-offset-3 col-sm-9">
                                <button name="submit" type="submit"id="submit" class="btn btn-success btn-sm"><i class="fa fa-unlock fa-2x"></i></button>
                                <button type="reset" class="btn btn-default btn-sm"><i class="fa fa-refresh fa-2x"></i></button>
                            </div>
                        </div>
                    </form>
		...
		?>
                ...
                <div class="panel-footer opacit" >Not Registered? <a class="btn btn-primary btn-sm "id="register"><i class="fa fa-user-plus fa-2x"></i></a>
